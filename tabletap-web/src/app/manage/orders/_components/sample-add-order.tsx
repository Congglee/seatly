...
import Quantity from "@/app/[locale]/guest/menu/_components/quantity";
...
export default function AddOrder() {
  ...
  const createOrder = async () => {
    try {
      ...
      if (!guestId) {
        toast({ description: "Hãy chọn một khách hàng" });
        return;
      }
              ...
              <div className="flex-shrink-0 ml-auto flex justify-center items-center">
                <Quantity
                  onQuantityChange={(quantity) =>
                    handleQuantityChange(dish.id, quantity)
                  }
                  quantity={
