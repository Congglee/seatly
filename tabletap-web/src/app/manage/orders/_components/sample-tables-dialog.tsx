...
import { getVietnameseTableStatus } from "@/lib/utils/restaurant-status";
...
export function TablesDialog({ onTableChoose }: TablesDialogProps) {
  ...
  const [pagination, setPagination] = useState({
    // Giá trị mặc định ban đầu, không có ý nghĩa khi data được fetch bất đồng bộ
    pageIndex: 0,
                      ...
                      <TableRow
                        ...
                        onClick={() => {
                          if (
                            ...
                            handleTableSelect(row.original);
                          }
                        }}
                        className={cn({
                          "cursor-pointer":
