  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        {previewUrl ? (
          <div className="relative aspect-square w-full max-w-64 overflow-hidden rounded-[18px] bg-muted">
            <Image
              src={previewUrl}
              alt="Avatar preview"
              fill
          ...
          <button
            type="button"
            onClick={() => imageInputRef.current?.click()}
            className="flex w-full max-w-64 cursor-pointer flex-col items-center justify-center gap-3 rounded-[18px] px-6 py-8 text-center"
          >
