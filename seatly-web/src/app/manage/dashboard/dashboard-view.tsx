...
import type { DashboardIndicatorResType } from "@/schemas/dashboard.schema";
...
export default function DashboardView() {
  ...
  const dishRankingData = useMemo(
    () =>
      (dashboardData?.dishIndicator ?? []).map(
        (dish: DashboardIndicatorResType["data"]["dishIndicator"][number]) => ({
          id: dish.id,
          name: dish.name,
