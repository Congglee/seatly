            ...
            {tableList.map((table) => {
              ...
              return (
                <div
                  key={tableNumber}
                  className={cn(
                    "flex items-stretch gap-3 rounded-lg border border-transparent bg-secondary px-3 py-2.5 text-sm transition-colors",
                    canOpenGuestDetail &&
                  ...
                  onClick={() => {
                    if (canOpenGuestDetail) setSelectedTableNumber(tableNumber);
                  }}
                ...
                >
                  ...
                  <Separator
                    ...
                    className="h-auto self-stretch bg-muted-foreground/30"
                  />
                  {!hasActiveOrders && (
