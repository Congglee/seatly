...
interface OrderStatusFilterProps<TData, TValue> {
  column?: Column<TData, TValue>;
}

export default function OrderStatusFilter<TData, TValue>({
  column,
}: OrderStatusFilterProps<TData, TValue>) {
  ...
  return (
    <Popover>
      ...
      >
        <Command>
          <CommandInput placeholder="Tìm trạng thái đơn..." />
          <CommandList>
