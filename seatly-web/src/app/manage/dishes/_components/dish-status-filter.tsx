...
interface DishStatusFilterProps<TData, TValue> {
  column?: Column<TData, TValue>;
}

export default function DishStatusFilter<TData, TValue>({
  column,
}: DishStatusFilterProps<TData, TValue>) {
  ...
  return (
    <Popover>
      ...
      >
        <Command>
          <CommandInput placeholder="Tìm trạng thái món..." />
          <CommandList>
