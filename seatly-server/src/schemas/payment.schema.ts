...
export type PaymentTransactionSchemaType = z.TypeOf<typeof PaymentTransactionSchema>
...
export type CreateGuestQrPaymentResType = z.TypeOf<typeof CreateGuestQrPaymentRes>
...
export const ManualPaymentBody = z.object({
  guestId: z.string(),
  method: z.enum([PaymentMethod.Cash, PaymentMethod.ManualBankTransfer]).default(PaymentMethod.ManualBankTransfer)
})
