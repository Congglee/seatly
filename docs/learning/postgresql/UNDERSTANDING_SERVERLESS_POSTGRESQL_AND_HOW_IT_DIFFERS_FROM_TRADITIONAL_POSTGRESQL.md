...
## Liên hệ với codebase Seatly

Trong dự án hiện tại:

- `seatly-server/prisma/schema.prisma:5` đang cấu hình datasource PostgreSQL
- `seatly-server/.env:7` hiện đang dùng local PostgreSQL
...
Với dự án như Seatly dùng Fastify + Prisma + Next.js, đây là hướng đáng cân nhắc nếu ưu tiên phát triển nhanh, ít vận hành và muốn tận dụng workflow cloud hiện đại.
